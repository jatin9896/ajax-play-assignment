...
package controllers {
  ...
  class ReverseSignUpController(_prefix: => String) {
    ...
    def addUser(id:String, pass:String): Call = {
      import ReverseRouteContext.empty
      Call("POST", _prefix + { _defaultPrefix } + "adduser/" + implicitly[PathBindable[String]].unbind("id", id) + queryString(List(Some(implicitly[QueryStringBindable[String]].unbind("pass", pass)))))
    }
